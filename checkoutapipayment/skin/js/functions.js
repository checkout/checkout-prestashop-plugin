...
*	Kevin Klika, 2010. All rights reserved. No guaranties expressed or implied.
*/
...
*/
function doSetup() {
	//document.getElementById('cardLogoImg').onKeyDown = "checkForm";

	if(document.getElementById('checkoutapipayment_form')) {
		addListener(document.getElementById('checkoutapipayment_form'), 'submit', formSubmit);
	}
}
