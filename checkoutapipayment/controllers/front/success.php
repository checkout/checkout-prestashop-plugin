...
class CheckoutapipaymentSuccessModuleFrontController extends ModuleFrontController
{
  ...
  public function initContent() {
    ...
    if (preg_match('/^1[0-9]+$/', $respondCharge->getResponseCode())) {
      ...
      $this->module->validateOrder((int) $cart->id, Configuration::get('PS_OS_ERROR'), $total, $this->module->displayName, 'An error has occcur while processing this transaction (' . $respondCharge->getResponseLongMessage() . ')', array
